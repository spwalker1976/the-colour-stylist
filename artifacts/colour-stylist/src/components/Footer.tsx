      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          <div className="lg:col-span-1">
            <div className="mb-4">
              <span className="font-serif text-lg tracking-wide block" style={{ fontFamily: "'Playfair Display', Georgia, serif", letterSpacing: "0.06em" }}>
                The Colour Stylist
              </span>
              <span className="text-[10px] tracking-[0.22em] uppercase text-[hsl(185,60%,65%)] font-sans mt-1 block">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xs tracking-[0.18em] uppercase text-white/40 mb-5 font-sans">Navigation</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="text-xs tracking-[0.18em] uppercase text-white/40 mb-5 font-sans">Services</h4>
            <ul className="space-y-3">
              {[
          ...
          {/* Contact */}
          <div>
            <h4 className="text-xs tracking-[0.18em] uppercase text-white/40 mb-5 font-sans">Get in Touch</h4>
            <ul className="space-y-3">
              <li>
                <a
                  href={WHATSAPP_LINK}
