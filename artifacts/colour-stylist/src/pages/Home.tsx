...
const testimonials = [
  {
    name: "Sarah R.",
    quote:
      "Clare made the whole experience feel relaxed and enjoyable. I left with a much clearer understanding of the colours that suit me and far more confidence in what I wear.",
  },
  {
    name: "Rachel P.",
    quote:
      "Such a thoughtful and professional session. The advice was practical, easy to apply and has genuinely changed the way I shop for clothes and makeup.",
  },
  {
    name: "Emma R.",
    quote:
      "I had such a lovely experience. Clare immediately put me at ease, and the results have made getting dressed so much simpler and more enjoyable.",
  },
];
...
const services = [
  {
    ...
    description:
      "A personalised in-person colour analysis using the 12 season system to identify the shades that naturally enhance your features.",
    href: "/services/colour-analysis-in-person",
  },
  {
    title: "Colour Analysis with Friends",
    description:
      "A relaxed and enjoyable session with friends or family, where you'll each discover the colours that make you glow.",
    href: "/services/colour-analysis-with-friends",
  },
  {
    title: "Wardrobe Declutter",
    description:
      "A practical styling session to edit, refine and create a wardrobe that works for your personal style.",
...
export default function Home() {
  return (
    <main>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
            ...
            <div>
              ...
              <h1
                className="font-serif text-[hsl(220,15%,22%)] text-4xl sm:text-5xl lg:text-6xl font-medium leading-[1.12] tracking-wide mb-7"
              ...
              <p className="text-[hsl(220,15%,40%)] text-base leading-relaxed mb-3 max-w-md">
              ...
              <p className="text-[hsl(220,15%,40%)] text-base leading-relaxed mb-10 max-w-md">
                For women at every stage of life, whether you're refining your style, or looking to feel more like yourself again.
              </p>
      ...
      {/* Services Overview with Background Image */}
      <section className="relative py-24">
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{ backgroundImage: "url('/images/services-background.jpg')" }}
        />
        <div className="absolute inset-0 bg-[hsl(220,15%,22%)]/70" />
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-14">
            <p className="text-[10px] tracking-[0.22em] uppercase text-white/50 mb-3">What I offer</p>
            <h2
              className="font-serif text-white text-3xl lg:text-4xl font-medium tracking-wide"
              style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
            >
              Services
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
            ...
            <div className="relative">
              ...
              <div
                className="absolute -top-4 -right-4 w-32 h-32 -z-10 hidden lg:block"
                style={{ backgroundColor: "hsl(350,35%,90%)" }}
              />
            </div>
            {/* Right: Text */}
            <div>
              ...
              <h2
                className="font-serif text-[hsl(220,15%,22%)] text-3xl lg:text-4xl font-medium mb-6 tracking-wide"
                style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
              >
                Hi, I'm Clare
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
            ...
            <div>
              ...
              <h2
                className="font-serif text-[hsl(220,15%,22%)] text-3xl lg:text-4xl font-medium mb-3 tracking-wide"
                style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
              >
                What is Colour Analysis?
              </h2>
              <p className="text-[hsl(185,42%,33%)] text-sm italic mb-6" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
      ...
      <section className="py-24 bg-[hsl(220,15%,22%)]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-14">
            <p className="text-[10px] tracking-[0.22em] uppercase text-white/35 mb-3">Kind Words</p>
            <h2
              className="font-serif text-white text-3xl lg:text-4xl font-medium tracking-wide"
              style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
            >
          ...
          <div className="text-center">
            <Link
              href="/testimonials"
              className="text-white/50 hover:text-white text-xs tracking-[0.15em] uppercase font-medium transition-colors no-underline"
            >
